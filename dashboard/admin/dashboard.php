...
<head>
    ...
    <title>quản trị viên | Calbeans Coffee</title>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-11 mx-md-0 px-xl-1 mx-auto">
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row justify-content-between">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Các sản phẩm</h5>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 col-11 mx-md-0 px-xl-1 mx-auto">
                        <div class="card card-stats mb-4 mb-xl-0">
                            <div class="card-body">
                                <div class="row justify-content-between">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0">Đơn đặt hàng
</h5>
            ...
            <div class="card shadow col-xl-12 col mt-5 mb-xl-0 mb-5 px-0 mx-auto">
                ...
                <section class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0">những đơn đặt hàng gần đây
</h3>
                        </div>

            ...
            <div class="table-responsive mt-lg-2 mt-md-4 mt-5 ">
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    <th class="__prod_code"scope="col">mã sản phẩm</th>
                    <th class="__prod_name" scope="col">tên</th>
                    <th class="__prod_category" scope="col">loại</th>
                    <th class="__prod_price" scope="col">giá</th>
                    <th scope="col">ảnh</th>
